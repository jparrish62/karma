...
ActiveRecord::Schema.define(version: 20161220214506) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.string   "user_name"
    t.integer  "works_id"
    t.index ["stylist_id"], name: "index_comments_on_stylist_id"
    t.index ["user_id"], name: "index_comments_on_user_id"
    t.index ["works_id"], name: "index_comments_on_works_id"
  end
  ...
  create_table "works", force: :cascade do |t|
    ...
    t.integer  "image_file_size"
    t.datetime "image_updated_at"
    t.index ["stylist_id"], name: "index_works_on_stylist_id"
